  ...
  Future<void> addToCart(
    ...
    if (_isNetworkAvail) {
      try {
        ...
        print("manage cart api here ${manageCartApi} and ${parameter}");
                      ...
                      SimBtn(
                          ...
                          onBtnSelected: () async {
                            if (oriPrice > 0) {
                              ...
                              if (isAvailable) {
                                var headers = {
                                  'Cookie': 'ci_session=f38f8db9f7070434ed919254e4f41b7b868a43f7'
                                };
                                var request = http.MultipartRequest('POST', Uri.parse('${baseUrl}get_packing_charge'));
                                ...
                                if (response.statusCode == 200) {
                                  ...
                                  print("checking final response here ${jsonResponse}");
                                  setState(() {
                                    packingCharges = jsonResponse['packing_charge'].toString();
                                    finalTotalValue = jsonResponse['data'].toString();
                                    print("checking final charge value here ${finalResult}");
                                  });
                                }
                                else {
                                          ...
                                          Padding(
                                              ...
                                              child: Column(
                                                crossAxisAlignment:
                                                    CrossAxisAlignment.start,
                                                children: [
                                             finalTotalValue == null || finalTotalValue == "" ?   Text(
                                                    CUR_CURRENCY! +
    ...
    if (_isNetworkAvail) {
      ...
      try {
        var parameter = {
          ...
          'packing_charge' : packingCharges == null || packingCharges == "" ? "0" : '${packingCharges.toString()}',
