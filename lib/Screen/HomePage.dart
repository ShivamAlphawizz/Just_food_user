                ...
                child: Row(
                  children: [
                   Padding(
                     ...
                     child: Icon(Icons.search,color: colors.blackTemp),
                   ),
                    SizedBox(width: 5,),
                    Text("Search...",style: TextStyle(color: colors.blackTemp),),
                  ],
                )
              ),
            ),
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => SellerList(
                                      ...
                                      getByLocation: false,
                                      banner: catList[index].banner.toString(),
                                      sellerList: [],
                                    )
                                )
                            );
...
setState(() {
  ...
  void getCat() {
    ...
    print("checking category api here ${getCatApi} and ${parameter}");
