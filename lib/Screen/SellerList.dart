...
class SellerList extends StatefulWidget {
  ...
  List<Product> sellerList;
   SellerList(
      {Key? key, this.catId,this.banner ,this.subId, this.catName, this.getByLocation,required this.sellerList})
      : super(key: key);
...
class _SellerListState extends State<SellerList> {
  ...
  Widget build(BuildContext context) {
    print("checking cat id ${widget.catId}");
    return Scaffold(
        ...
        body: !loading&&sellerList.length>0
          ...
          children: [
       widget.banner == "" ? SizedBox.shrink() : Padding(
              padding: EdgeInsets.symmetric(horizontal: 10,vertical: 10),
              child: Container(
                height: 150,
                //padding: EdgeInsets.symmetric(horizontal: 10,),
                width: MediaQuery.of(context).size.width,
                child: Image.network("${imageBase}${widget.banner}",fit: BoxFit.fill,),
              ),
            ),
            Expanded(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              sellerList[index].permissions!['whatsapp_show'] == "0" ? SizedBox.shrink():   Row(
                                children: [
                                  InkWell(
                                    onTap: (){
