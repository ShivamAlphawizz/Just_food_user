...
class StateProduct extends State<ProductList> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    print("PPPPPPPPPPPPPPPPPPPPPPPPPP  ${widget.id}");
  ...
  Future<void> addToCart(int index, String qty) async {
    ...
    if (_isNetworkAvail) {
      if (CUR_USERID != null) {
        ...
        print("sdsdsds ${manageCartApi} and ${parameter}");
        apiBaseHelper.postAPICall(manageCartApi, parameter).then((getdata) {
          bool error = getdata["error"];
          String? msg = getdata["message"];
          print("msg here now ${msg}");
          Fluttertoast.showToast(msg: "${msg}");
          if(msg == 'your cart contains item already seller.Do you want to clear the cart and add item from other seller '){
          ...
          if (!error) {
            ...
            String? qty = data['total_quantity'].toString();
